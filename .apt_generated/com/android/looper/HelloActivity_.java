...
import com.android.looper.R.id;
    ...
    extends HelloActivity
{
    ...
    private void afterSetContentView_() {
        loopSurfaceView = ((LoopSurfaceView) findViewById(id.sample));
        init();
    }
    ...
    public void initBackground() {
        BackgroundExecutor.execute(new Runnable() {
            ...
            public void run() {
                try {
                    HelloActivity_.super.initBackground();
                } catch (RuntimeException e) {
                    Log.e("HelloActivity_", "A runtime exception was thrown while executing code in a runnable", e);
                }
            }
